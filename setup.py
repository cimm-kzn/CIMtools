...
setup(
    ...
    install_requires=['networkx>=2.0.dev', 'CGRtools>=2.7', 'typing', 'pandas', 'scipy', 'dill', 'sortedcontainers',
                      'sklearn', 'requests', 'multiprocess'],
    dependency_links=['git+https://github.com/networkx/networkx.git@master#egg=networkx-2.0.dev',
                      'git+https://github.com/stsouko/CGRtools.git@master#egg=CGRtools-2.7'],
